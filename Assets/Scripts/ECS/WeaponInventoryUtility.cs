...
namespace Chronocaust.Ecs
{
    ...
    public static class WeaponInventoryUtility
    {
        ...
        public static WeaponSlotEntry FromWeaponComponent(in WeaponComponent source) => new WeaponSlotEntry
        {
        ...
        public static void AddWeaponTypeTags(EcsWorld world, EntityId id, in WeaponSlotEntry entry)
        {
            switch (entry.Kind)
            {
                ...
                case WeaponKind.Melee:
                    ...
                    {
                        Range = entry.MeleeRange > 0f ? entry.MeleeRange : 1.5f,
                        ArcAngle = entry.MeleeArcAngle > 0f ? entry.MeleeArcAngle : 90f
                    });
                    break;
            }
        }
